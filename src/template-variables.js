export const defaultVariables = () => {
  ...
  return {
    ...
    monthNameShort: d.toLocaleDateString([], { localeMatcher: 'best fit', month: 'short' }),
    monthNameLong: d.toLocaleDateString([], { localeMatcher: 'best fit', month: 'long' }),
    dayNum: d.getDate(),
    dayNumLZ: String(d.getDate()).padStart(2, 0),
    dayNameShort: d.toLocaleDateString([], { localeMatcher: 'best fit', weekday: 'short' }),
    dayNameLong: d.toLocaleDateString([], { localeMatcher: 'best fit', weekday: 'long' }),
